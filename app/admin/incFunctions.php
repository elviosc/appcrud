	...
	*/
	...
	function getTableList($skip_authentication = false) {
		...
		$arrTables = [
			...
			'Posts' => ['Posts', '', 'table.gif', 'None'],
			'Categoria' => ['Categoria', '', 'table.gif', 'None'],
			'Tags' => ['Tags', '', 'table.gif', 'None'],
			'Midia' => ['Midia', '', 'table.gif', 'None'],
		];
	...
	function getThumbnailSpecs($tableName, $fieldName, $view) {
		if($tableName=='Posts' && $fieldName=='midia' && $view=='dv')
	...
	*/
	...
	function lookupQuery($tn, $lookupField) {
		...
		*/
		$lookupQuery = [
			'Posts' => [
				'caregoria_id' => 'SELECT `Categoria`.`id`, `Categoria`.`Categoria` FROM `Categoria` ORDER BY 2',
				'tag_id' => 'SELECT `Tags`.`id`, `Tags`.`Tag` FROM `Tags` ORDER BY 2',
			],
			'Categoria' => [
			],
			'Tags' => [
